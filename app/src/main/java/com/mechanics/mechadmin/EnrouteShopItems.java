...
public class EnrouteShopItems extends Fragment {

    private CartHistoryAdapter adapter;
    private DatabaseReference databaseReference, deliveredReference;
//    private ArrayList<String> keyArray;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("En Route Items");
        deliveredReference = FirebaseDatabase.getInstance().getReference().child("Delivered Items");
...
//                    keyArray.add(dataSnapshot1.getKey());
    ...
    public class CartHistoryAdapter extends RecyclerView.Adapter<CartHistoryAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
            ...
            //Set button text
            holder.proceedItem.setText("Delivered");
            holder.proceedItem.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(context);
                    builder.setTitle("Confirmation");
                    builder.setMessage("Are you sure you the product has been delivered?");
                    builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            String made = "Confirmed! Products is now Delivered. Thanks for using FABAT";
                            ...
                            updateStatus.put("Trans Status", "Delivered");
                            ...
                            valuesToCustomer.put("Trans Status", "Delivered");
                            ...
                            databaseReference.child(theUID).removeValue()
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            ...
                                            deliveredReference.child(theUID).setValue(valuesToCustomer)
                                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                        @Override
                                                        public void onComplete(@NonNull Task<Void> task) {
                                                            ...
                                                            databaseReference.child("Notification Collection").child("Customer")
                                                                    ...
                                                                    .setValue(sentMessage).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                        ...
                                                                        public void onComplete(@NonNull Task<Void> task) {
                                                                            ...
                                                                            Toast.makeText(getContext(), "SUCCESSFUL, Item delivered...", Toast.LENGTH_SHORT).show();
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String[] a = {mData.get(position).getPrice(), mData.get(position).getStreetname(),
                            ...
                            "Delivered", mData.get(position).getTransId(), "En Route"};
