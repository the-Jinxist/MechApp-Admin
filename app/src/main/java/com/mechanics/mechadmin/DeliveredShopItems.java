...
public class DeliveredShopItems extends Fragment {

    private CartHistoryAdapter adapter;
    private DatabaseReference databaseReference, coldHistoryReference;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Delivered Items");
        coldHistoryReference = FirebaseDatabase.getInstance().getReference().child("Stacked Items");
...
//                    keyArray.add(dataSnapshot1.getKey());
    ...
    public class CartHistoryAdapter extends RecyclerView.Adapter<CartHistoryAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
            ...
            //Set button text
            holder.proceedItem.setText("Stack");
            holder.proceedItem.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(context);
                    builder.setTitle("Confirmation");
                    builder.setMessage("Are you sure you want to stack the order?");
                    builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            updateStatus.put("Trans Status", "Stacked");
                            ...
                            valuesToCustomer.put("Trans Status", "Stacked");
                            ...
                            databaseReference.child(theUID).removeValue()
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            ...
                                            coldHistoryReference.child(theUID).setValue(valuesToCustomer)
                                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                        @Override
                                                        public void onComplete(@NonNull Task<Void> task) {
                                                            ...
                                                            Toast.makeText(getContext(), "SUCCESSFUL, Item Stacked...", Toast.LENGTH_SHORT).show();
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String[] a = {mData.get(position).getPrice(), mData.get(position).getStreetname(),
                            ...
                            "Stacked", mData.get(position).getTransId(), "Delivered"};
